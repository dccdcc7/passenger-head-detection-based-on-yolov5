...
def train(hyp, opt, device, callbacks):
    ...
    (w.parent if evolve else w).mkdir(parents=True, exist_ok=True)  # make dir2.27kB/
...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="models/yolov5s_scnet.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default="data/VOC1.yaml", help="dataset.yaml path")
...
if __name__ == "__main__":
    ...
    #ssh root@connect.westb.seetacloud.com 27894
